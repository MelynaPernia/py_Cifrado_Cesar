...
do{
  ...
  var text=prompt("EMPECEMOS, INGRESA TU FRASE");
...
document.write("La frase es :  "+text+"<br>"
+"Tu frase cifrada es :  " + cipher(text,33)+"<br>"+" Tu frase descifrada es : " + decipher(cipher(text,33),33));
